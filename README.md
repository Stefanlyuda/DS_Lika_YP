...
|14_Выпускной проект_`telecom`    |[Прогнозирование оттока клиентов.Классификаиця] (https://github.com/BerlinLika11/DS_Lika_YP/tree/main/%E2%84%9614_Diploma_telecom)     | `EDA`,`Pandas`,`Marketing Analyst`,`SKlearn`,`NumPy`,`Data Preprocessing`,`SDA`,`Feature Engineering`,`Machine Learning`,`OOP`
